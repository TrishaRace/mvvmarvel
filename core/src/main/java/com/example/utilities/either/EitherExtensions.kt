package com.example.utilities.either

import com.example.utilities.either.Either.Failure
import com.example.utilities.either.Either.Success
...
inline val Either<*, *>.isSuccess get() = this is Success

inline val Either<*, *>.isFailure get() = this is Failure
